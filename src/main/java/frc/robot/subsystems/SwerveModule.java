...
public class SwerveModule extends SubsystemBase {
  ...
  public SwerveModuleState getState() {
    return new SwerveModuleState(getDriveVelocity(), new Rotation2d(getAbsoluteEncoderRad()/*getTurningPosition()*/));//switch between neo encoders and abs encoders
  }

  public SwerveModulePosition getPosition() {
	return new SwerveModulePosition(getDriveVelocity(), new Rotation2d(getAbsoluteEncoderRad()/*getTurningPosition()*/));//switch between neo encoders and abs encoders
  }
